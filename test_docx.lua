-- @description Test DOCX Extractor (ReaImGui)
-- @version 1.0.0
-- @author Slava Logutin
-- @about Interactive test suite for DOCX XML extraction and dialogue parsing in REAPER using ReaImGui.
-- @provides
--   [main] .
--   modules/docx_xml_extractor.lua > modules/docx_xml_extractor.lua
--   modules/docx_xml_parser.lua > modules/docx_xml_parser.lua
--   modules/docx_dialogue_parser.lua > modules/docx_dialogue_parser.lua
--   modules/Parse.lua > modules/Parse.lua
--   modules/Utf8Tools.lua > modules/Utf8Tools.lua
--   modules/Utf8SimpleLowerData.lua > modules/Utf8SimpleLowerData.lua
--   modules/zip_archive.lua > modules/zip_archive.lua
